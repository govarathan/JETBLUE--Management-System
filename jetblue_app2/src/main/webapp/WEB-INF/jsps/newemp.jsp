...
<div class="form-group row"> Department: <input type="text" class="form-control mb-2 mr-sm-2" placeholder="Enter Department"name="dept"/></div>
<div class="form-group row"> Salary: <input type="text" class="form-control mb-2 mr-sm-2" placeholder="Enter Salary"name="salary"/></div>
<div class="form-group row"> Experience: <input type="text" class="form-control mb-2 mr-sm-2" placeholder="Enter Experience"name="exp"/></div>
